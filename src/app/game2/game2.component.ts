...
export class Game2Component {
  answers = [
      { text: 'THE COMMUTE', revealed: false, score: 38 },
      { text: 'PRISON ARCHITECTURE', revealed: false, score: 24 },
      { text: 'NO SOCIAL LIFE', revealed: false, score: 16 },
      { text: 'STUDYING', revealed: false, score: 8 },
      { text: 'THE STRESS', revealed: false, score: 7 },
      { text: 'PARKING', revealed: false, score: 3 },
      { text: 'THE WEATHER', revealed: false, score: 2 },
      { text: "IDK I'M NEW", revealed: false, score: 2 },
      // add up to 8 answers
    ];
