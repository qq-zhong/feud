...
export class Game3Component {
  answers = [
    { text: 'STUDY', revealed: false, score: 30 },
    { text: 'CRY, GET STRESSED/UPSET', revealed: false, score: 15 },
    { text: 'WORK', revealed: false, score: 13 },
    { text: 'SLEEP', revealed: false, score: 12 },
    { text: 'USE THE BATHROOM', revealed: false, score: 10 },
    { text: 'DRINK', revealed: false, score: 8 },
    { text: 'DO CHORES', revealed: false, score: 6 },
    { text: 'GET SICK/INJURED', revealed: false, score: 6 },
    // add up to 8 answers
  ];
